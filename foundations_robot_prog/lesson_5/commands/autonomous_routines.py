...
def drive_straight_routine(drivetrain, speed):
    ...
    return commands2.cmd.sequence(
        ...
        # you use your custom command and a timeout method call to run it for a set.
        # duration. Note that commands execute on every clock tick until terminated.
...
#       a) Instantiate a command object using your custom donut drive class.
...
#          Then, immediately call .withTimeout() from that object, passing this
#          method 1 (for 1 second) as its only argument.
