...
class WestCoastDrivetrain(commands2.SubsystemBase):
    ...
    def setDeadband(self, deadband):
        """
        Change the deadband additive percentage for the overall drivetrain to the
        given value. This will be added to the motor deadbands to get a final
        deadband output percentage for the drive motors.

        Args:
            deadband: output percentage to add with domain [0, 1]
