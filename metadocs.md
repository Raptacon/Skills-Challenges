...
- Clicking the step number header will open the file requiring code
- Within the opened code file, look for "FOR YOU (\<development_step_number_here\>)" within the code - this signals that you have something to do.
